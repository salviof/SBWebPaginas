...
public class WebPaginasServlet extends HttpServlet implements Serializable {
        ...
        try {
            if (SBCore.isEmModoDesenvolvimento()) {
                ...
                if (sitMapEncontado == null) {
                    sitMapEncontado = UtilCRCReflexao.getClasseQueEstendeIsto(MB_SiteMapa.class, "br.org.carameloCode.erp.crm.config");
                }
    ...
    protected void doGet(HttpServletRequest requisicao, HttpServletResponse resposta) throws ServletException, IOException {
        ...
        String recurso = null;
        ComoUsuario usuario = controleDeSessao.getSessaoAtual().getUsuario();
        try {
