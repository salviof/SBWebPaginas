...
public enum FabUrlServletRecepcaoOauth implements ItfFabUrlServletSBFW, Serializable {
    ...
    NOME_PARAMETRO,
    @InfoParametroURL(nome = "Tipo Autenticacao", tipoParametro = TIPO_PARTE_URL.OBJETO_COM_CONSTRUCTOR, fabricaObjetosRelacionada = FabTipoClienteOauth.class, tipoEntidade = TipoClienteOauth.class)
    TIPO_CLIENTE_OAUTH,
